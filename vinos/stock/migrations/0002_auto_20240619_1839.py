...
def create_initial_data(apps, schema_editor):
    ...
    # Crear usuarios
    user1 = User.objects.create_user(username='empleado1', password='password1', first_name='Juan', last_name='Perez')
    user2 = User.objects.create_user(username='empleado2', password='password2', first_name='Ana', last_name='Gomez')

    # Crear empleados
    Employee.objects.create(user=user1, dni=12345678, cuil='20-12345678-5', branch=branch1)
    Employee.objects.create(user=user2, dni=87654321, cuil='23-87654321-1', branch=branch2)
